...
//           <h2 className="text-4xl leading-[36px] text-center font-bold text-[#282734]">
//             Work With Us
//           </h2>
//         </div>
...
//           // className="min-h-[1550px] max-sm:min-h-[1600px] max-321:!min-h-[1800px] max-h-[1990px] mb-10 w-full"
