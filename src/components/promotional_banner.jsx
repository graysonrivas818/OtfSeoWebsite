                        ...
                        {isMobile && (
                            <>
                                ...
                                <p className="text-[14px] text-white/80 mb-4 max-w-[290px] font-montserrat">
                                    We back our plans with a 60-day money-back guarantee if you do not see measurable results, and we also guarantee #1 rankings—or we will work for free until you are ranked #1!                                </p>
                                <button
